...
> To stay up to date on new Pine Script<sup>®</sup> features, keep an eye on the User Manual's
  [Release notes](https://www.tradingview.com/pine-script-docs/en/v5/Release_notes.html).
